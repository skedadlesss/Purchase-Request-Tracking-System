        ...
        <div class="col-lg-6 col-md-6 mx-auto">
          <div class="card text-center">
            ...
            <div class="card-header" id="approved-request-header" style="background-color:#3B5828; color: white;">
              List of Requests <i class="fa-sharp fa-solid fa-caret-down" style="float:right;font-size: 25px;" ></i>
            </div>

            <div class="card-body d-none">
              <h5 class="card-title"><i class="fas fa-check-circle" style="color:#3B5828;"></i> Requests </h5>
              <p class="card-text">All pending, approved, and declined request items from all units are listed here.</p>
              <a href="admin-approve.php" class="btn btn-primary btn-sm">Enter Here</a>
            </div>
  ...
  <div class="col-lg-6 col-md-6 mx-auto">
    <div class="card text-center">
      ...
      <div class="card-body d-none">
        ...
        <p class="card-text"> Sorry you dont have enough privilege to enter here, if you wish to continue use the admin account instead </p>
        <button type="button" class="btn btn-sm  btn-primary" disabled>Enter Here</button>
      </div>
